...
\input{Tables/type_by-cand_S} & \input{Tables/type_by-cand_H} & \input{Tables/type_by-cand_G}
\end{tabularx}
...
\begin{tabularx}{\linewidth}{CCC}
\input{Tables/runoff_by-cand_S} & \input{Tables/runoff_by-cand_H} & \input{Tables/runoff_by-cand_G}
\end{tabularx}
...
\centering
\begin{tabularx}{\linewidth}{CCC}
  \input{Tables/party_by-cand_S} & \input{Tables/party_by-cand_H} &\input{Tables/party_by-cand_G}
\end{tabularx}
\end{adjustwidth}
...
\centering
{\scriptsize
\input{Tables/party-formal_by-office}
}
\end{adjustwidth}
...
\end{itemize}
    ...
    \begin{tabularx}{\linewidth}{CCC}
    \input{Tables/inc_by-cand_S} & \input{Tables/inc_by-cand_H} & \input{Tables/inc_by-cand_G}
    \end{tabularx}
...
\begin{tabularx}{\linewidth}{C}
\input{Tables/nextup_by-cand_S}
\end{tabularx}

\begin{tabularx}{\linewidth}{C}
\input{Tables/nextup_by-cand_H} 
\end{tabularx}

\begin{tabularx}{\linewidth}{C}
\input{Tables/nextup_by-cand_G}
\end{tabularx}
...
Presidential candidates win electoral college votes at the state level, but only win office with a majority of the college votes. Because of this ambiguity, we have left this variable missing for Presidential candidates.
    ...
    \begin{tabularx}{\linewidth}{CCC}
    \input{Tables/won_by-cand_S} & \input{Tables/won_by-cand_H} & \input{Tables/won_by-cand_G}
    \end{tabularx}

The set of tables below show the \emph{party} of the candidate that \emph{won}. 

    \begin{tabularx}{\linewidth}{CCC}
    \input{Tables/party-won_by-cand_S} & \input{Tables/party-won_by-cand_H} & \input{Tables/party-won_by-cand_G}
    \end{tabularx}
