...
The formal names of candidate's party affiliation, for example DFL in Minnesota. Third party candidate names follow what is given in the House Clerk document or state SOS reports (for Governors), with some minor abbreviations and standardizations.
