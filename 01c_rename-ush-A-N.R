...
js_20 <- js_20 %>%
  ...
  mutate(
    name = replace(name, dist == 1 & state == "NY" & party == "Working Families", "GOROFF, NANCY S."),
    name = replace(name, dist == 2 & state == "NY" & party == "Working Families", "GORDON, JACKIE"),
    name = replace(name, dist == 2 & state == "NY" & party == "Independence", "GORDON, JACKIE"),
    name = replace(name, dist == 3 & state == "NY" & party == "Working Families", "SUOZZI, THOMAS R. (TOM)"),
    name = replace(name, dist == 3 & state == "NY" & party == "Independence", "SUOZZI, THOMAS R. (TOM)"),
    name = replace(name, dist == 6 & state == "NY" & party == "Working Families", "MENG, GRACE"),
    name = replace(name, dist == 7 & state == "NY" & party == "Working Families", "VELAZQUEZ, NYDIA M."),
    name = replace(name, dist == 8 & state == "NY" & party == "Working Families", "JEFFRIES, HAKEEM S."),
    name = replace(name, dist == 9 & state == "NY" & party == "Working Families", "CLARKE, YVETTE D."),
    name = replace(name, dist == 10 & state == "NY" & party == "Working Families", "NADLER, JERROLD L. (JERRY)"),
    name = replace(name, dist == 11 & state == "NY" & party == "Independence", "ROSE, MAX N."),
    name = replace(name, dist == 13 & state == "NY" & party == "Working Families", "ESPAILLAT, ADRIANO"),
    name = replace(name, dist == 17 & state == "NY" & party == "Working Families", "JONES, MONDAIRE"),
    name = replace(name, dist == 18 & state == "NY" & party == "Working Families", "MALONEY, SEAN PATRICK"),
    name = replace(name, dist == 18 & state == "NY" & party == "Independence", "MALONEY, SEAN PATRICK"),
    name = replace(name, dist == 19 & state == "NY" & party == "Working Families", "DELGADO, ANTONIO"),
    name = replace(name, dist == 19 & state == "NY" & party == "Save American Movement", "DELGADO, ANTONIO"),
    name = replace(name, dist == 20 & state == "NY" & party == "Working Families", "TONKO, PAUL DAVID"),
    name = replace(name, dist == 20 & state == "NY" & party == "Independence", "TONKO, PAUL DAVID"),
    name = replace(name, dist == 21 & state == "NY" & party == "Working Families", "COBB, TEDRA L."),
    name = replace(name, dist == 22 & state == "NY" & party == "Working Families", "BRINDISI, ANTHONY"),
    name = replace(name, dist == 22 & state == "NY" & party == "Independence", "BRINDISI, ANTHONY"),
    name = replace(name, dist == 23 & state == "NY" & party == "Working Families", "MITRANO, TRACY"),
    name = replace(name, dist == 25 & state == "NY" & party == "Working Families", "MORELLE, JOSEPH D."),
    name = replace(name, dist == 25 & state == "NY" & party == "Independence", "MORELLE, JOSEPH D."),
    name = replace(name, dist == 26 & state == "NY" & party == "Working Families", "HIGGINS, BRIAN M."),
    name = replace(name, dist == 26 & state == "NY" & party == "Save America Movement", "HIGGINS, BRIAN M."),
    name = replace(name, dist == 27 & state == "NY" & party == "Working Families", "MCMURRAY, NATHAN D.")
  ) %>%
  # Republicans
  mutate(
    name = replace(name, dist == 1 & state == "NY" & party == "Conservative", "ZELDIN, LEE M."),
    name = replace(name, dist == 1 & state == "NY" & party == "Independence", "ZELDIN, LEE M."),
    name = replace(name, dist == 2 & state == "NY" & party == "Conservative", "GARBARINO, ANDREW R."),
    name = replace(name, dist == 2 & state == "NY" & party == "Libertarian", "GARBARINO, ANDREW R."),
    name = replace(name, dist == 2 & state == "NY" & party == "Serve America Movement", "GARBARINO, ANDREW R."),
    name = replace(name, dist == 3 & state == "NY" & party == "Conservative", "SANTOS, GEORGE A. D"),
    name = replace(name, dist == 4 & state == "NY" & party == "Conservative", "TUMAN, DOUGLAS L."),
    name = replace(name, dist == 6 & state == "NY" & party == "Conservative", "ZMICH, THOMAS J."),
    name = replace(name, dist == 6 & state == "NY" & party == "Save Our City", "ZMICH, THOMAS J."),
    name = replace(name, dist == 6 & state == "NY" & party == "Libertarian", "ZMICH, THOMAS J."),
    name = replace(name, dist == 7 & state == "NY" & party == "Conservative", "KELLY, BRIAN W."),
    name = replace(name, dist == 8 & state == "NY" & party == "Conservative", "WALLACE, GARFIELD H."),
    name = replace(name, dist == 9 & state == "NY" & party == "Conservative", "JEAN-PIERRE, CONSTANTINE"),
    name = replace(name, dist == 10 & state == "NY" & party == "Conservative", "BERNSTEIN, CATHY A."),
    name = replace(name, dist == 11 & state == "NY" & party == "Conservative", "MALLIOTAKIS, NICOLE"),
    name = replace(name, dist == 12 & state == "NY" & party == "Conservative", "SANTIAGO-CANO, CARLOS"),
    name = replace(name, dist == 14 & state == "NY" & party == "Conservative", "CUMMINGS, JOHN C."),
    name = replace(name, dist == 15 & state == "NY" & party == "Conservative", "DELICES, PATRICK"),
    name = replace(name, dist == 18 & state == "NY" & party == "Conservative", "FARLEY, CHELE CHIAVACCI"),
    name = replace(name, dist == 18 & state == "NY" & party == "Serve America Movement", "SMITH, SCOTT A."),
    name = replace(name, dist == 20 & state == "NY" & party == "Conservative", "JOY, ELIZABETH L."),
    name = replace(name, dist == 20 & state == "NY" & party == "Serve America Movement", "JOY, ELIZABETH L."),
    name = replace(name, dist == 21 & state == "NY" & party == "Conservative", "STEFANIK, ELISE M."),
    name = replace(name, dist == 21 & state == "NY" & party == "Independence", "STEFANIK, ELISE M."),
    name = replace(name, dist == 22 & state == "NY" & party == "Conservative", "TENNEY, CLAUDIA"),
    name = replace(name, dist == 23 & state == "NY" & party == "Conservative", "REED, THOMAS W. (TOM), II"),
    name = replace(name, dist == 23 & state == "NY" & party == "Independence", "REED, THOMAS W. (TOM), II"),
    name = replace(name, dist == 24 & state == "NY" & party == "Conservative", "KATKO, JOHN M."),
    name = replace(name, dist == 24 & state == "NY" & party == "Independence", "KATKO, JOHN M."),
    name = replace(name, dist == 25 & state == "NY" & party == "Conservative", "MITRIS, GEORGE"),
    name = replace(name, dist == 27 & state == "NY" & party == "Constitution", "JACOBS, CHRIS"),
